...
# Draw line chart
plot(table(data$MaxTemp),type="l",xaxt="n",main= "The distribution of cases happened from 2011-2015",xlab="Temperature in degrees Fahrenheit", ylab="Number of cases",col="red")
lines(table(data$MinTemp),type="l",col="blue",lty=2)
axis(1,at=seq(0,120,3))
legend("topleft", legend=c("Max Temperature", "Min Temperature"),col=c("red", "blue"), lty=1:2, cex=0.8)
```

According to the figure above, when the daily maximum temperature is between 85 degree and 87 degree, the number of crime cases would reach the peak. When the daily minimum temperature is between 66 degree and 69 degree, the number of crime cases would reach the peak. However, when the daily maximum temperature is higher than 87 degree or the daily minimum temperature is lower than 72 degree, the number of crimes would reduce significantly. 
...
#ARSON
hist(rangeT_arson$Range.of.Temp,main= "The distribution of 'ARSON' cases  2011-2015", xlab="Range of temperature in degrees Fahrenheit", ylab="Number of cases",col="purple") 
#ASSAULT
hist(rangeT_assault$Range.of.Temp,main= "The distribution of 'ASSAULT' cases  2011-2015", xlab="Range of temperature in degrees Fahrenheit", ylab="Number of cases",col="purple") 
#BURGLARY
hist(rangeT_burglary$Range.of.Temp,main= "The distribution of 'BURGLARY' cases 2011-2015", xlab="Range of temperature in degrees Fahrenheit", ylab="Number of cases",col="purple") 
#HOMICIDE
hist(rangeT_homicide$Range.of.Temp,main= "The distribution of 'HOMICIDE' cases 2011-2015", xlim=c(0, 50),xlab="Range of temperature in degrees Fahrenheit", ylab="Number of cases",col="purple") 
#MOTOR VEHICLE THEFT
hist(rangeT_mvt$Range.of.Temp,main= "The distribution of 'MOTOR VEHICLE THEFT' cases 2011-2015", xlab="Range of temperature in degrees Fahrenheit", ylab="Number of cases",col="purple") 
#ROBBERY
hist(rangeT_robbery$Range.of.Temp,main= "The distribution of 'ROBBERY' cases 2011-2015", xlab="Range of temperature in degrees Fahrenheit", ylab="Number of cases",col="purple") 
#SEX ABUSE
hist(rangeT_sa$Range.of.Temp,main= "The distribution of 'SEX ABUSE' cases 2011-2015", xlab="Range of temperature in degrees Fahrenheit", ylab="Number of cases",col="purple") 
#THEFT FROM AUTO
hist(rangeT_thefa$Range.of.Temp,main= "The distribution of 'THEFT FROM AUTO' cases 2011-2015", xlab="Range of temperature in degrees Fahrenheit", ylab="Number of cases",col="purple") 
#THEFT FROM OTHER
hist(rangeT_thefot$Range.of.Temp,main= "The distribution of 'THEFT FROM OTHER' cases 2011-2015", xlab="Range of temperature in degrees Fahrenheit", ylab="Number of cases",col="purple") 

```
According to the 9 figures above, when the daily temperature difference is between 10 degree and 30 degree, the number of various crime cases would increase. Based on the existing weather dataset, on the whole, the period from September to December as well as from March to June is the period when most crime cases happen. 
...
ggplot(maxT_arson,aes(MaxTemp,NumberofCases))+ 
  ...
  labs(title = "The relationship between number of 'ARSON' cases and average temperature 2011-2015", x="Temperature in degrees Fahrenheit", y="Number of cases")+
  theme_xkcd+
...
ggplot(maxT_assault,aes(MaxTemp,NumberofCases))+ 
  geom_point()+
  geom_smooth(method='lm')+
  labs(title = "The relationship between number of 'ASSAULT' cases and average temperature 2011-2015", x="Temperature in degrees Fahrenheit", y="Number of cases")+
  theme_xkcd+
  theme(plot.title = element_text(hjust = 0.5))
#BURGLARY
ggplot(maxT_burglary,aes(MaxTemp,NumberofCases))+ 
  geom_point()+
  geom_smooth(method='lm')+
  labs(title = "The relationship between number of 'BURGLARY' cases and average temperature 2011-2015", x="Temperature in degrees Fahrenheit", y="Number of cases")+
  theme_xkcd+
  theme(plot.title = element_text(hjust = 0.5))
#HOMICIDE
ggplot(maxT_homicide,aes(MaxTemp,NumberofCases))+ 
  geom_point()+
  geom_smooth(method='lm')+
  labs(title = "The relationship between number of 'HOMICIDE' cases and average temperature 2011-2015", x="Temperature in degrees Fahrenheit", y="Number of cases")+
  theme_xkcd+
  theme(plot.title = element_text(hjust = 0.5))
#MOTOR VEHICLE THEFT
ggplot(maxT_mvt,aes(MaxTemp,NumberofCases))+ 
  geom_point()+
  geom_smooth(method='lm')+
  labs(title = "The relationship between number of 'MOTOR VEHICLE THEFT' cases and average temperature 2011-2015", x="Temperature in degrees Fahrenheit", y="Number of cases")+
  theme_xkcd+
  theme(plot.title = element_text(hjust = 0.5))
#ROBBERY
ggplot(maxT_robbery,aes(MaxTemp,NumberofCases))+ 
  geom_point()+
  geom_smooth(method='lm')+
  labs(title = "The relationship between number of 'ROBBERY' cases and average temperature 2011-2015", x="Temperature in degrees Fahrenheit", y="Number of cases")+
  theme_xkcd+
  theme(plot.title = element_text(hjust = 0.5))
#SEX ABUSE
ggplot(maxT_sa,aes(MaxTemp,NumberofCases))+ 
  geom_point()+
  geom_smooth(method='lm')+
  labs(title = "The relationship between number of 'SEX ABUSE' cases and average temperature 2011-2015", x="Temperature in degrees Fahrenheit", y="Number of cases")+
  theme_xkcd+
  theme(plot.title = element_text(hjust = 0.5))
#THEFT FROM AUTO
ggplot(maxT_thefa,aes(MaxTemp,NumberofCases))+ 
  geom_point()+
  geom_smooth(method='lm')+
  labs(title = "The relationship between number of 'THEFT FROM AUTO' cases and average temperature 2011-2015", x="Temperature in degrees Fahrenheit", y="Number of cases")+
  theme_xkcd+
  theme(plot.title = element_text(hjust = 0.5))
#THEFT FROM OTHER
ggplot(maxT_thefot,aes(MaxTemp,NumberofCases))+ 
  geom_point()+
  geom_smooth(method='lm')+
  labs(title = "The relationship between  number of 'THEFT FROM OTHER' cases and average temperature 2011-2015", x="Temperature in degrees Fahrenheit", y="Number of cases")+
  theme_xkcd+
  theme(plot.title = element_text(hjust = 0.5))


```
According to the 9 figures above, with the increase of average temperature, the number of various crime cases also increases. The temperature is directly proportional to the number of crime cases. However, the average temperature of the days when most cases happen is between 65 degree and 90 degree. Meanwhile, the number of the type of theft cases is much larger than other kinds of crime cases.
...
Crime_Incidents__2011 <- read.csv("Crime_Incidents__2011.csv")

Crime_Incidents__2012 <- read.csv("Crime_Incidents__2012.csv")

Crime_Incidents__2013 <- read.csv("Crime_Incidents__2013.csv")

Crime_Incidents__2014 <- read.csv("Crime_Incidents__2014.csv")

Crime_Incidents__2015 <- read.csv("Crime_Incidents__2015.csv")

NightClubs_DC <- read.csv("NightClubs_DC.csv")
...
# [Step 3.1] Removing the unwanted rows after inspecting the new data

new=newdata[15:84,]

# [Step 4] Creating a plot of total crimes vs cluster[number of night clubs] for all years 2011-2015

g=ggplot(new, aes(x = Cluster, y = value, colour = variable)) + geom_line(size=1.25) + ylab(label="Number of crimes") + xlab("Cluster[Number of NightClubs]") 


# [Step 4.1] Adding details to the plot: create breakpoints on x-axis (each cluster) and labelling them cluster-number[number of nightclubs in that cluster], giving the plot a title and marking each point on each plotline

g=g + theme(axis.line = element_line(colour = "black"))+scale_x_continuous(breaks=c(1,2,3,4,6,7,8,9,18,22,23,25,26,27),
labels = c("1[13]", "2[3]", "3[16]", "4[2]", "6[28]", "7[1]", "8[18]", "9[1]", "18[1]", "22[3]", "23[1]", "25[6]", "26[2]", "27[11]")) + geom_point() + ggtitle("Total number of crimes in each cluster[number of Night Clubs]")

# [Step 4.2] Modifying the legend (table defining the different line plots) on the right of the plot: creating a background, renaming the variables in the legend for clear understanding

g=g+ theme(legend.background = element_rect(fill="gray90", size=.5, linetype="dotted"))+ scale_colour_discrete(name  ="Total Number of Crimes for Each Year", breaks=c("Number.Total.Crimes.2011", "Number.Total.Crimes.2012","Number.Total.Crimes.2013","Number.Total.Crimes.2014","Number.Total.Crimes.2015"), 
labels=c("2011", "2012","2013","2014","2015")) + scale_shape_discrete(name  ="Total Number of Crimes for Each Year", 
breaks=c("Number.Total.Crimes.2011", "Number.Total.Crimes.2012","Number.Total.Crimes.2013","Number.Total.Crimes.2014","Number.Total.Crimes.2015"),
...
# [Step 6] Loading the ggplot2 library and adding details to the plot: create breakpoints on x-axis (each cluster) and labelling them cluster-number[number of nightclubs in that cluster], giving the plot a title and marking each point on each plotline

g=ggplot(new.arson.data, aes(x = Cluster, y = value, colour = variable)) + geom_line(size=1.25) + ylab(label="Number of crimes (Arson)") + xlab("Cluster[Number of NightClubs]") 
g=g + theme(axis.line = element_line(colour = "black"))+scale_x_continuous(breaks=c(2,18,23), labels = c("2[3]", "18[1]", "23[1]")) + geom_point() + ggtitle("Total number of arsons in each cluster[number of Night Clubs]")

# [Step 6.1] Modifying the legend (table defining the different line plots) on the right of the plot: creating a background, renaming the variables in the legend for clear understanding

g=g + theme(legend.background = element_rect(fill="gray90", size=.5, linetype="dotted")) + scale_colour_discrete(name  ="Total Number of Arsons for Each Year", breaks=c("Number.Arson.2011", "Number.Arson.2012","Number.Arson.2013","Number.Arson.2014","Number.Arson.2015"), labels=c("2011", "2012","2013","2014","2015"))
...
g=ggplot(new.assault.data, aes(x = Cluster, y = value, colour = variable)) + geom_line(size=1.25) + ylab(label="Number of crimes (Assault)") + xlab("Cluster[Number of NightClubs]") 
g=g + theme(axis.line = element_line(colour = "black"))+scale_x_continuous(breaks=c(1,2,3,4,6,7,8,9,18,22,23,25,26,27), labels = c("1[13]", "2[3]", "3[16]", "4[2]", "6[28]", "7[1]", "8[18]", "9[1]", "18[1]", "22[3]", "23[1]", "25[6]", "26[2]", "27[11]")) + geom_point() + ggtitle("Total number of assaults in each cluster[number of Night Clubs]")

# [Step 6.1] Modifying the legend (table defining the different line plots) on the right of the plot: creating a background, renaming the variables in the legend for clear understanding

g=g + theme(legend.background = element_rect(fill="gray90", size=.5, linetype="dotted")) + scale_colour_discrete(name  ="Total Number of Assaults for Each Year", breaks=c("Number.Assault.2011", "Number.Assault.2012","Number.Assault.2013","Number.Assault.2014","Number.Assault.2015"), labels=c("2011", "2012","2013","2014","2015")) + scale_shape_discrete(name  ="Total Number of Assaults for Each Year", breaks=c("Number.Assault.2011", "Number.Assault.2012","Number.Assault.2013","Number.Assault.2014","Number.Assault.2015"),labels=c("2011", "2012","2013","2014","2015"))
...
g=ggplot(new.burglary.data, aes(x = Cluster, y = value, colour = variable)) + geom_line(size=1.25) + ylab(label="Number of crimes (Burglary)") + xlab("Cluster[Number of NightClubs]") 
g=g + theme(axis.line = element_line(colour = "black"))+scale_x_continuous(breaks=c(1,2,3,4,6,7,8,9,18,22,23,25,26,27), labels = c("1[13]", "2[3]", "3[16]", "4[2]", "6[28]", "7[1]", "8[18]", "9[1]", "18[1]", "22[3]", "23[1]", "25[6]", "26[2]", "27[11]")) + geom_point() + ggtitle("Total number of burglaries in each cluster[number of Night Clubs]")

# [Step 6.1] Modifying the legend (table defining the different line plots) on the right of the plot: creating a background, renaming the variables in the legend for clear understanding

g=g + theme(legend.background = element_rect(fill="gray90", size=.5, linetype="dotted")) + scale_colour_discrete(name  ="Total Number of Burglaries for Each Year", breaks=c("Number.Burglary.2011", "Number.Burglary.2012","Number.Burglary.2013","Number.Burglary.2014","Number.Burglary.2015"), labels=c("2011", "2012","2013","2014","2015")) + scale_shape_discrete(name  ="Total Number of Burglaries for Each Year", breaks=c("Number.Burglary.2011", "Number.Burglary.2012","Number.Burglary.2013","Number.Burglary.2014","Number.Burglary.2015"),labels=c("2011", "2012","2013","2014","2015"))
...
new.homicide.data=new.homicide[13:42,]
#new.homicide.data

# [Step 6] Loading the ggplot2 library and adding details to the plot: create breakpoints on x-axis (each cluster) and labelling them cluster-number[number of nightclubs in that cluster], giving the plot a title and marking each point on each plotline

g=ggplot(new.homicide.data, aes(x = Cluster, y = value, colour = variable)) + geom_line(size=1.25) + ylab(label="Number of crimes (Homicide)") + xlab("Cluster[Number of NightClubs]")

g=g + theme(axis.line = element_line(colour = "black"))+scale_x_continuous(breaks=c(2,3,18,22,23,25), labels = c("2[3]", "3[16]", "18[1]", "22[3]", "23[1]", "25[6]")) + geom_point() + ggtitle("Total number of homicides in each cluster[number of Night Clubs]")

# [Step 6.1] Modifying the legend (table defining the different line plots) on the right of the plot: creating a background, renaming the variables in the legend for clear understanding

g=g + theme(legend.background = element_rect(fill="gray90", size=.5, linetype="dotted")) + scale_colour_discrete(name  ="Total Number of Homicides for Each Year", breaks=c("Number.Homicide.2011", "Number.Homicide.2012","Number.Homicide.2013","Number.Homicide.2014","Number.Homicide.2015"), labels=c("2011", "2012","2013","2014","2015")) + scale_shape_discrete(name  ="Total Number of Homicides for Each Year", breaks=c("Number.Homicide.2011", "Number.Homicide.2012","Number.Homicide.2013","Number.Homicide.2014","Number.Homicide.2015"),labels=c("2011", "2012","2013","2014","2015"))
...
g=ggplot(new.motortheft.data, aes(x = Cluster, y = value, colour = variable)) + geom_line(size=1.25)+ylab(label="Number of crimes (MotorTheft)") + xlab("Cluster[Number of NightClubs]") 


g=g + theme(axis.line = element_line(colour = "black"))+scale_x_continuous(breaks=c(1,2,3,4,6,7,8,9,18,22,23,25,26,27), labels = c("1[13]", "2[3]", "3[16]", "4[2]", "6[28]", "7[1]", "8[18]", "9[1]", "18[1]", "22[3]", "23[1]", "25[6]", "26[2]", "27[11]")) + geom_point() + ggtitle("Total number of motor thefts in each cluster[number of Night Clubs]")

# [Step 6.1] Modifying the legend (table defining the different line plots) on the right of the plot: creating a background, renaming the variables in the legend for clear understanding

g=g + theme(legend.background = element_rect(fill="gray90", size=.5, linetype="dotted")) + scale_colour_discrete(name  ="Total Number of MotorThefts for Each Year", breaks=c("Number.MotorTheft.2011", "Number.MotorTheft.2012","Number.MotorTheft.2013","Number.MotorTheft.2014","Number.MotorTheft.2015"), labels=c("2011", "2012","2013","2014","2015")) + scale_shape_discrete(name  ="Total Number of MotorThefts for Each Year", breaks=c("Number.MotorTheft.2011", "Number.MotorTheft.2012","Number.MotorTheft.2013","Number.MotorTheft.2014","Number.MotorTheft.2015"),labels=c("2011", "2012","2013","2014","2015"))
...
g=ggplot(new.robbery.data, aes(x = Cluster, y = value, colour = variable)) + geom_line(size=1.25) + ylab(label="Number of crimes (Robbery)") + xlab("Cluster[Number of NightClubs]") 

g=g + theme(axis.line = element_line(colour = "black"))+scale_x_continuous(breaks=c(1,2,3,4,6,7,8,9,18,22,23,25,26,27), labels = c("1[13]", "2[3]", "3[16]", "4[2]", "6[28]", "7[1]", "8[18]", "9[1]", "18[1]", "22[3]", "23[1]", "25[6]", "26[2]", "27[11]")) + geom_point() + ggtitle("Total number of robberies in each cluster[number of Night Clubs]")

# [Step 6.1] Modifying the legend (table defining the different line plots) on the right of the plot: creating a background, renaming the variables in the legend for clear understanding

g=g + theme(legend.background = element_rect(fill="gray90", size=.5, linetype="dotted")) + scale_colour_discrete(name  ="Total Number of Robberies for Each Year", breaks=c("Number.Robbery.2011", "Number.Robbery.2012","Number.Robbery.2013","Number.Robbery.2014","Number.Robbery.2015"), labels=c("2011", "2012","2013","2014","2015")) + scale_shape_discrete(name  ="Total Number of Robberys for Each Year", breaks=c("Number.Robbery.2011", "Number.Robbery.2012","Number.Robbery.2013","Number.Robbery.2014","Number.Robbery.2015"),labels=c("2011", "2012","2013","2014","2015"))
...
g=ggplot(new.sexabuse.data, aes(x = Cluster, y = value, colour = variable)) + geom_line(size=1.25) + ylab(label="Number of crimes (SexAbuse)") + xlab("Cluster[Number of NightClubs]") 

g=g + theme(axis.line = element_line(colour = "black"))+scale_x_continuous(breaks=c(1,2,3,4,6,7,8,18,22,23,25,26), labels = c("1[13]", "2[3]", "3[16]", "4[2]", "6[28]", "7[1]", "8[18]", "18[1]", "22[3]", "23[1]", "25[6]", "26[2]")) + geom_point() + ggtitle("Total number of sex abuse cases in each cluster[number of Night Clubs]")

# [Step 6.1] Modifying the legend (table defining the different line plots) on the right of the plot: creating a background, renaming the variables in the legend for clear understanding

g=g + theme(legend.background = element_rect(fill="gray90", size=.5, linetype="dotted")) + scale_colour_discrete(name  ="Total Number of Sex Abuse cases for Each Year", breaks=c("Number.SexAbuse.2011", "Number.SexAbuse.2012","Number.SexAbuse.2013","Number.SexAbuse.2014","Number.SexAbuse.2015"), labels=c("2011", "2012","2013","2014","2015")) + scale_shape_discrete(name  ="Total Number of Sex Abuse cases for Each Year", breaks=c("Number.SexAbuse.2011", "Number.SexAbuse.2012","Number.SexAbuse.2013","Number.SexAbuse.2014","Number.SexAbuse.2015"),labels=c("2011", "2012","2013","2014","2015"))
...
g=ggplot(new.autotheft.data, aes(x = Cluster, y = value, colour = variable)) + geom_line(size=1.25) + ylab(label="Number of crimes (AutoTheft)") + xlab("Cluster[Number of NightClubs]") 

g=g + theme(axis.line = element_line(colour = "black"))+scale_x_continuous(breaks=c(1,2,3,4,6,7,8,9,18,22,23,25,26,27), labels = c("1[13]", "2[3]", "3[16]", "4[2]", "6[28]", "7[1]", "8[18]", "9[1]", "18[1]", "22[3]", "23[1]", "25[6]", "26[2]", "27[11]")) + geom_point() + ggtitle("Total number of auto theft cases in each cluster[number of Night Clubs]")

# [Step 6.1] Modifying the legend (table defining the different line plots) on the right of the plot: creating a background, renaming the variables in the legend for clear understanding

g=g + theme(legend.background = element_rect(fill="gray90", size=.5, linetype="dotted")) + scale_colour_discrete(name  ="Total Number of Auto Theft cases for Each Year", breaks=c("Number.AutoTheft.2011", "Number.AutoTheft.2012","Number.AutoTheft.2013","Number.AutoTheft.2014","Number.AutoTheft.2015"), labels=c("2011", "2012","2013","2014","2015")) + scale_shape_discrete(name  ="Total Number of Auto Theft cases for Each Year", breaks=c("Number.AutoTheft.2011", "Number.AutoTheft.2012","Number.AutoTheft.2013","Number.AutoTheft.2014","Number.AutoTheft.2015"),labels=c("2011", "2012","2013","2014","2015"))
...
g=ggplot(new.othertheft.data, aes(x = Cluster, y = value, colour = variable)) + geom_line(size=1.25) + ylab(label="Number of crimes (OtherTheft)") + xlab("Cluster[Number of NightClubs]") 

g=g + theme(axis.line = element_line(colour = "black"))+scale_x_continuous(breaks=c(1,2,3,4,6,7,8,9,18,22,23,25,26,27), labels = c("1[13]", "2[3]", "3[16]", "4[2]", "6[28]", "7[1]", "8[18]", "9[1]", "18[1]", "22[3]", "23[1]", "25[6]", "26[2]", "27[11]")) + geom_point() + ggtitle("Total number of other theft cases in each cluster[number of Night Clubs]")

# [Step 6.1] Modifying the legend (table defining the different line plots) on the right of the plot: creating a background, renaming the variables in the legend for clear understanding

g=g + theme(legend.background = element_rect(fill="gray90", size=.5, linetype="dotted")) + scale_colour_discrete(name  ="Total Number of Auto Theft cases for Each Year", breaks=c("Number.OtherTheft.2011", "Number.OtherTheft.2012","Number.OtherTheft.2013","Number.OtherTheft.2014","Number.OtherTheft.2015"), labels=c("2011", "2012","2013","2014","2015")) + scale_shape_discrete(name  ="Total Number of Auto Theft cases for Each Year", breaks=c("Number.OtherTheft.2011", "Number.OtherTheft.2012","Number.OtherTheft.2013","Number.OtherTheft.2014","Number.OtherTheft.2015"),labels=c("2011", "2012","2013","2014","2015"))
...
# From the plot, it is clear that a huge number of other thefts occur in cluster 8 and the least in cluster 27. But, there is no 
# relation between the number of clubs in that cluster and the number of crimes.
